        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><NavLink to="/gallery" className="hover:text-yellow-300">Gallery</NavLink></li>
              <li><NavLink to="/livestream" className="hover:text-yellow-300">Livestream</NavLink></li>
              <li><NavLink to="/pastors-corner" className="hover:text-yellow-300">Pastor's Corner</NavLink></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold text-white tracking-wider uppercase">Get Involved</h4>
            <ul className="mt-4 space-y-2">
              <li><NavLink to="/spiritual-growth" className="hover:text-yellow-300">Spiritual Growth</NavLink></li>
